...
{
    public partial class InvoiceTransactionsHeader
    {
        ...
        public double? DiscountLine1 { get; set; }
        public double? DiscountLine2 { get; set; }
        public double? DiscountLine3 { get; set; }
        public double? DiscountLine4 { get; set; }
        public double? DiscountLine5 { get; set; }
        public string DiscountGroupId1 { get; set; }
        public string DiscountGroupId2 { get; set; }
        public string DiscountGroupId3 { get; set; }
        public string DiscountGroupId4 { get; set; }
        public string DiscountGroupId5 { get; set; }
        public string BranchCode { get; set; }
        public double? PosreceiptAmount { get; set; }
